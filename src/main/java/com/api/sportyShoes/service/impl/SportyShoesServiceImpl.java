...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	@PostConstruct
	public void init() {
		Shoe s1 = new Shoe(1,"Shoe Name 1","Basketball",1400.00);
		Shoe s2 = new Shoe(2,"Shoe Name 2","Cricket",650.00);
		Shoe s3 = new Shoe(3,"Shoe Name 3","Running",750.00);
		Shoe s4 = new Shoe(4,"Shoe Name 4","Football",1300.00);
		Shoe s5 = new Shoe(5,"Shoe Name 5","Canvas",450.00);
		...
		Date d = new Date(0);
		PurchaseReport pr1 = new PurchaseReport(6,"user_1","Running",d,"adidas_runner:5,puma_flat:10,nike_airmax:10");
		PurchaseReport pr2 = new PurchaseReport(7,"user_2","Cricket",d,"adidas_cricket:5,puma_spikes:10,nike_cricket:10");
		PurchaseReport pr3 = new PurchaseReport(8,"user_3","Basketball",d,"adidas_basketball:5,puma_jump:10,nike_basketball:10");
		PurchaseReport pr4 = new PurchaseReport(9,"user_4","Football",d,"adidas_football:5,puma_shooter:10,nike_football:10");
		PurchaseReport pr5 = new PurchaseReport(10,"user_5","Canvas",d,"puma_regular:10,agc_regular:10,sporty_canvas:10");
